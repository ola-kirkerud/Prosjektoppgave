...
plt.title('Scenario 6: Head-on situation, Stationary Linear Plow, \u03B1 = ' +alpha+ '\u00B0')
...
plt.title('Scenario 6: Head-on situation, Dynamic Linear Plow, \u03B1 = ' +alpha+ '\u00B0')
...
plt.title('Scenario 6: Head-on situation, Dynamic Jointed Plow, \u03B1 = ' +alpha+ '\u00B0')
