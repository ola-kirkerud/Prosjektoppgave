...
plt.title('Scenario 9: Overtaking situation, Stationary Linear Plow, \u03B1 = ' +alpha+ '\u00B0')
...
plt.title('Scenario 9: Overtaking situation, Dynamic Linear Plow, \u03B1 = ' +alpha+ '\u00B0')
...
plt.title('Scenario 9: Overtaking situation, Dynamic Jointed Plow, \u03B1 = ' +alpha+ '\u00B0')
